...
;
	($.$hyoo_match_final) = class $hyoo_match_final extends ($.$mol_page) {
		...
		Content(){
			const obj = new this.$.$mol_text();
			(obj.text) = () => ("\" 💞 Поздравляю всех, кто уже нашёл свою вторую половинку!\n\" 💔 А кто сейчас грустит один - заползай на match.hyoo.ru - сервис знакомств, которому выгодно, чтобы ты нашёл себе пару и свалил в закат.\n\" ✨ Никаких фейков, мёртвых душ, рекламы, премиумов и геймификаций. Ищи, пока не найдёшь.\n\" 🤙 Поделись в своих каналах или закидывай в чаты, где обитаешь - пусть каждый найдёт свою любовь.\n\" 🙏 Проект не коммерческий, так что вся надежда на тебя: чем больше соберём народу, тем больше найдётся пар.");
			return obj;
		}
		title(){
			return "Ждём персон";
